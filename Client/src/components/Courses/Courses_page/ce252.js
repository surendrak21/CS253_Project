    ...
    <div className="outerBox">
        <div className="container course-box">
            <div className="course-info">
                ...
                <p><strong>Course Title:</strong> CE252 SOIL MECHANICS</p>
                <p><strong>Instructor:</strong> Gaurav  Tiwari, PRISHATI  RAYCHOWDHURY </p>
                <p><strong>Course Description:</strong> This course covers fundamental principles of soil machanics.</p>
                <p><strong>Prerequisites:</strong> </p>
                <p><strong>Course Duration:</strong> 13 weeks</p>
                <p><strong>Course Schedule:</strong> Monday 11-12, Tuesday 12-13, Friday 12-13, Monday 14-17, Tuesday 14-17, Friday 14-17</p>
            </div>
