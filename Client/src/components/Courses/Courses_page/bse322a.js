    ...
    <div className="outerBox">
        <div className="container course-box">
            <div className="course-info">
                ...
                <p><strong>Course Title:</strong> BSE322A Bioinformatics and Computational Biology</p>
                <p><strong>Instructor:</strong> Dr. Nitin Gupta</p>
                <p><strong>Course Description:</strong> The objective of the course is to introduce students to the rapidly evolving field of bioinformatics. The term "bioinformatics" often means different things to different scientists, and our goal is not to cover all those things. Rather, we will aim to cover in the lectures the most fundamental topics, such as sequence alignment and pattern finding, and then explore some of the frontier areas through the "team debates". After completing this course, the students will gain an understanding of the computational challenges (and their solutions) in the analysis of large biological data sets; they will understand how some of the commonly used bioinformatics tools work, how to use these tools effectively, and how to read and evaluate research articles in the field.</p>
                <p><strong>Prerequisites:</strong> </p>
                <p><strong>Course Duration:</strong> 13 weeks</p>
                <p><strong>Course Schedule:</strong> Monday 10-11, Tuesday 10-11, Friday 10-11</p>
            </div>
